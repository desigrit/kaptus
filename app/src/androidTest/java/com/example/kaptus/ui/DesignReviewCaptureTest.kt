...
class DesignReviewCaptureTest {
            ...
            KaptusTheme {
                when (page.value) {
                    ...
                    "settings" -> SettingsScreen(
                        credentials = ProviderCredentials(), settings = AppSettings(),
    ...
    private fun capture(name: String) {
        ...
        val directory = instrumentation.targetContext.getExternalFilesDir("design-review")!!
        directory.mkdirs()
        val bitmap = instrumentation.uiAutomation.takeScreenshot()
        File(directory, "${variant}_$name.png").outputStream().use {
    ...
    private fun samplePlayer(): PlayerUiState {
        val caption = SubtitleEntry(1, 0, 4_000, "There are days that define your story.")
        return PlayerUiState(
            title = "Arrival", sourceName = "Arrival.2016.BluRay.en.srt",
